...
define('BOT_TOKEN', '260590869:AAGd8h1aJB6EjDLQQHmchPXKGrV41azqSLY');
...
کانلا ما  👈        [pvnobot](https://telegram.me/joinchat/CgbG0D8Xz4hkgPCXeZcD0g)

🔹هر نفر = یک ربات ✖️
🔸ربات دوم = 5000ت ✔️
🤖 @pvnobot',"parse_mode"=>"MARKDOWN","disable_web_page_preview"=>"true"));
...
🗣پیام ارسال شد");
        ...
        file_put_contents($id.'/launcher.php',$phptext);
        file_get_contents('https://api.telegram.org/bot'.$matches[1].'$texttwebhook?url=');
        file_get_contents('https://api.telegram.org/bot'.$matches[1].'/setwebhook?url=https://pm-mbmahdi.rhcloud.com//'.$chat_id.'/launcher.php');
...
🗣پیام ارسال شد");
        ...
        $phptext = str_replace("**ADMIN**",$chat_id,$phptext);
        file_put_contents($token.$id.'/launcher.php',$phptext);
        file_get_contents('https://api.telegram.org/bot'.$text.'/setwebhook?url=');
        file_get_contents('https://api.telegram.org/bot'.$text.'/setwebhook?url=https://pm-mbmahdi.rhcloud.com//'.$chat_id.'/launcher.php');
...
.";
    ...
    $bot_url    = "https://api.telegram.org/bot260590869:AAGd8h1aJB6EjDLQQHmchPXKGrV41azqSLY/"; 
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[0].'/setwebhook?url=https://pm-mbmahdi.rhcloud.com//'.$id.'/launcher.php');
    $unstalled = "ربات شما با موفقیت نصب شده است🚀 
برای ورود به ربات خود کلیک کنید 👇😃
به ربات ما امتیاز بدید  👇
 https://telegram.me/storebot?start=pvnobot
.";
